...
void	Parser_CPU_RAM_Time_Net::Find_CPUModel_Cores(void)
{
    FILE 			*in;
    char 			buff[512];
...
std::string	const & Parser_CPU_RAM_Time_Net::getModelCPU() const {
    return _model;
}

long Parser_CPU_RAM_Time_Net::getNumCPU() const {
    return _numCPU;
}
